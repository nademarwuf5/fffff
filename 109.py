...
threads = []
print(f'''
\033[2;36m  \033[1;33m NADER \033[2;36m\033[2;32m
\033[1;31m⊶⊶⊶⊶⊷⊷⊷⊷⊶⊶⊶⊶⊷⊷⊶⊶⊶⊶⊶⊶⊷⊷⊷⊷⊶⊶⊶⊶⊷⊷⊶⊶''')
print()
link1=input('\033[1;31mرابط 1: ')
link2=input('\033[1;32mرابط 2: ')
link3=input('\033[1;33mرابط 3: ')
link4=input('\033[1;34mرابط 4: ')
link5=input('\033[1;35mرابط 5: ')
link6=input('\033[1;36mرابط 6: ')
#################
def view2(proxy):
...
def send_seen(channel, msgid, proxy):
    ...
    try:
        ...
        if(i.text == "true"):
            print('\033[1;32mتم رشق بنجاح ✅:\033[1;33m'+now_view)           
    except Exception as e:
        return False
    try:
...
def scrap():
    try:
        https = requests.get("https://prosmmpanel.xyz/?request=displayproxies&proxytype=https&timeout=0", proxies=urllib.request.getproxies(), timeout=5).text
        ...
        socks = requests.get("https://prosmmpanel.xyz/?request=displayproxies&proxytype=socks5&timeout=0", proxies=urllib.request.getproxies(), timeout=5).text
    except Exception as e:
        print(e)
        return False
